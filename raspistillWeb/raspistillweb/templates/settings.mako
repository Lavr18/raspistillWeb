    ...
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
	      ...
	      <div class="form-group">
                <label for="AutostartEnabled1" class="col-lg-2 control-label">Autostart after Reboot</label>
                  <div class="col-lg-10">
                    <div class="btn-group" data-toggle="buttons">
                      <label class="btn btn-default ${'active' if autostart_enabled == 'Yes' else ''}" title="Automatically open the interface on startup.">
                        <input type="radio" name="autostartEnabled" value="Yes" ${'checked' if autostart_enabled == 'Yes' else ''}> Yes
                      </label>
                      <label class="btn btn-default ${'active' if autostart_enabled == 'No' else ''}" title="Do not automatically open the interface on startup.">
                        <input type="radio" name="autostartEnabled" value="No" ${'checked' if autostart_enabled == 'No' else ''}> No
                      </label>
                    </div>
                  </div>  
                </div>
	      ...
	      <div class="form-group">
                <label for="ButtonEnabled1" class="col-lg-2 control-label">External Button</label>
                  <div class="col-lg-10">
                    <div class="btn-group" data-toggle="buttons">
                      <label class="btn btn-default ${'active' if button_enabled == 'Yes' else ''}" title="Enable the ability to take a photo by pressing the button.">
                        <input type="radio" name="buttonEnabled" value="Yes" ${'checked' if button_enabled == 'Yes' else ''}> Yes
                      </label>
                      <label class="btn btn-default ${'active' if button_enabled == 'No' else ''}" title="Disable the ability to take a photo by pressing the button.">
                        <input type="radio" name="buttonEnabled" value="No" ${'checked' if button_enabled == 'No' else ''}> No
                      </label>
                    </div>
                  </div>  
                </div>
...
<script>		
   if (${button_indicator}) {
    	document.getElementById("physicalButtonEnabled").style.display="block";
   }
   else {
    	document.getElementById("physicalButtonEnabled").style.display="none";
   }		
</script>